...
exports.CobrancaController = void 0;
const axios_1 = require("axios");
const common_1 = require("@nestjs/common");
const axios_2 = require("@nestjs/axios");
require('dotenv').config();
const ASAAS_API_KEY = process.env.ASAAS_API_KEY;
let CobrancaController = class CobrancaController {
...
], CobrancaController.prototype, "createSubscription", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CobrancaController.prototype, "getSubscription", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CobrancaController.prototype, "deleteSubscription", null);
__decorate([
    (0, common_1.Post)(':id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], CobrancaController.prototype, "updateSubscription", null);
CobrancaController = __decorate([
    (0, common_1.Controller)('payments'),
    __metadata("design:paramtypes", [axios_2.HttpService])
], CobrancaController);
exports.CobrancaController = CobrancaController;
//# sourceMappingURL=cobranca.controller.js.map