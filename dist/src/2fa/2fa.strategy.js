...
const passport_otp_1 = require("passport-otp");
const auth_service_1 = require("../auth/auth.service");
let TwoFactorStrategy = class TwoFactorStrategy extends (0, passport_1.PassportStrategy)(passport_otp_1.Strategy, 'two-factor') {
